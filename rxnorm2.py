...
def getNDC(bPathStr, c):
    ...
    # print str(c) + '\t' + bPathStr
    rxcui = getLastOfPath(bPathStr)
    # print rxcui
    url = '/REST/rxcui/'+rxcui+'/ndcs.json'
    # print url
    nDCResult = getJson(url)
    # gNDC = json.loads(nDCResult)
    # a = list(json.loads(nDCResult).values())[0]['ndcList']['ndc']
    # print a
    # print list(json.loads(nDCResult).values())[0]['ndcList'] # = {u'ndc': [u'00074010150']}
    if list(json.loads(nDCResult).values())[0]['ndcList'] is not None:
        for ndcCode in list(json.loads(nDCResult).values())[0]['ndcList']['ndc']:
            # print ndcCode
            outStr = str(c) + '|' + bPathStr + '\\' +  ndcCode + '\\|' + ndcCode + '|' + leaf + '|NDC:' + ndcCode
            # print outStr
            fileOut(outStr)
    # print gNDC # = {u'ndcGroup': {u'ndcList': {u'ndc': [u'00074010150']}, u'rxcui': u'211805'}}
    # print list(gNDC.values()) # = [{u'ndcList': {u'ndc': [u'00074010150']}, u'rxcui': u'211805'}]
    # print list(gNDC.values())[0] # = {u'ndcList': {u'ndc': [u'00074010150']}, u'rxcui': u'211805'} -went from list to dict
    # print list(gNDC.values())[0]['ndcList'] # = {u'ndc': [u'00074010150']}
    # print list(gNDC.values())[0]['ndcList']['ndc'] # = [u'00074010150'] I now have my list :D
